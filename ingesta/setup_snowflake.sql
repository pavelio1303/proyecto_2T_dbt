...
-- =============================================================================
-- SECCIÓN 5: COPY INTO desde el stage
-- =============================================================================
-- Ejecutar una vez que los CSVs estén subidos al stage @RAW_STAGE.

COPY INTO RAW.BRANDS                FROM @RAW.RAW_STAGE/brands/                FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.CATEGORIES            FROM @RAW.RAW_STAGE/categories/            FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.STORES                FROM @RAW.RAW_STAGE/stores/                FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.STORE_BUSINESS_HOURS  FROM @RAW.RAW_STAGE/store_business_hours/  FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.EMPLOYEES             FROM @RAW.RAW_STAGE/employees/             FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.SUPPLIERS             FROM @RAW.RAW_STAGE/suppliers/             FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.PRODUCTS              FROM @RAW.RAW_STAGE/products/              FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.PRODUCT_VARIANTS      FROM @RAW.RAW_STAGE/product_variants/      FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.CUSTOMERS             FROM @RAW.RAW_STAGE/customers/             FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.DISCOUNTS             FROM @RAW.RAW_STAGE/discounts/             FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.DISCOUNT_CATEGORIES   FROM @RAW.RAW_STAGE/discount_categories/   FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.DISCOUNT_CUSTOMERS    FROM @RAW.RAW_STAGE/discount_customers/    FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.DISCOUNT_PRODUCTS     FROM @RAW.RAW_STAGE/discount_products/     FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.DISCOUNT_STORES       FROM @RAW.RAW_STAGE/discount_stores/       FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.INVENTORY_STOCK       FROM @RAW.RAW_STAGE/inventory_stock/       FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.SALES                 FROM @RAW.RAW_STAGE/sales/                 FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.SALE_ITEMS            FROM @RAW.RAW_STAGE/sale_items/            FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.SALE_ITEM_DISCOUNTS   FROM @RAW.RAW_STAGE/sale_item_discounts/   FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.PAYMENTS              FROM @RAW.RAW_STAGE/payments/              FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.RETURNS               FROM @RAW.RAW_STAGE/returns/               FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.RETURN_ITEMS          FROM @RAW.RAW_STAGE/return_items/          FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.REFUNDS               FROM @RAW.RAW_STAGE/refunds/               FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.STOCK_MOVEMENTS       FROM @RAW.RAW_STAGE/stock_movements/       FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.PURCHASE_ORDERS       FROM @RAW.RAW_STAGE/purchase_orders/       FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
COPY INTO RAW.PURCHASE_ORDER_ITEMS  FROM @RAW.RAW_STAGE/purchase_order_items/  FILE_FORMAT = RAW.CSV_FORMAT ON_ERROR = 'CONTINUE';
